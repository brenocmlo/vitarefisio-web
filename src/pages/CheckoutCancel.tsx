...
export const CheckoutCancel: React.FC = () => {
  ...
  return (
    <div className="flex min-h-screen items-center justify-center bg-slate-50 p-4 dark:bg-slate-950 transition-colors duration-500 relative overflow-hidden">
      <div className="absolute top-[-10%] left-[-10%] w-[40%] h-[40%] bg-rose-100/30 dark:bg-rose-900/10 rounded-full blur-[120px] pointer-events-none"></div>
      ...
      >
        ...
        <p className="text-slate-500 dark:text-slate-400 text-base leading-relaxed mb-8">
          Sua assinatura não foi concluída. Fique tranquilo(a), nenhuma cobrança foi realizada no seu cartão.
        </p>

        <div className="space-y-3">
          <button
            onClick={() => navigate('/')}
            className="w-full bg-blue-600 hover:bg-blue-700 text-white px-6 py-4 rounded-2xl font-bold text-sm transition-all shadow-lg hover:shadow-blue-200 active:scale-95 flex items-center justify-center gap-2"
          >
          ...
          <a
            href="https://wa.me/5585988335991?text=Tive um problema com meu pagamento no SomosFisio"
            target="_blank"
