import{j as e}from"./index-Ti7u-e7-.js";import{r as m}from"./vendor-react-C06hc36D.js";import{t as l}from"./vendor-ui-D6hDUFSp.js";function j(){const[o,d]=m.useState({nome:"",email:"",senha:"",telefone:"",conselho:"",profissionais:"",captcha:""}),[c,p]=m.useState(!1),f=i=>{const r=i.replace(/\D/g,"");return r.length<=10?r.replace(/^(\d{2})(\d)/g,"($1) $2").replace(/(\d{4})(\d)/,"$1-$2"):r.replace(/^(\d{2})(\d)/g,"($1) $2").replace(/(\d{5})(\d)/,"$1-$2")},a=i=>{const{id:r,value:t}=i.target;if(r==="telefone"){const s=f(t.slice(0,15));d(n=>({...n,[r]:s}))}else d(s=>({...s,[r]:t}))},u=i=>{if(i.preventDefault(),o.captcha.trim()!=="10"){l.error("Por favor, responda a verificação matemática corretamente: 9 + 1 = 10.");return}p(!0);try{const r=window.fbq;r&&r("track","Lead",{content_category:"Qualificacao_Geral",content_name:"Formulario_Experimentar"});const t=o.conselho.toUpperCase(),n={1:"Apenas eu (1)","2-5":"De 2 a 5","6-10":"De 6 a 10","11+":"Mais de 10"}[o.profissionais]||o.profissionais,x=`Olá SomosFisio! Acabei de preencher o formulário de qualificação para experimentar a plataforma:
...
Gostaria de criar minha conta e iniciar o teste gratuito!`,h=`https://wa.me/5585988335991?text=${encodeURIComponent(x)}`;l.success("Qualificação concluída com sucesso! Redirecionando para o WhatsApp..."),setTimeout(()=>{window.location.href=h},1e3)}catch{p(!1),l.error("Ocorreu um erro ao processar seu cadastro. Tente novamente.")}};return e.jsxs("div",{className:"formulario-page-root",children:[e.jsx("style",{children:`
