import{j as e,a as g}from"./index-Bh10qmwy.js";import{r as m,R as b}from"./vendor-react-C06hc36D.js";import{t as l}from"./vendor-ui-D6hDUFSp.js";function S(){const[o,d]=m.useState({nome:"",email:"",senha:"",telefone:"",conselho:"",profissionais:"",captcha:""}),[c,p]=m.useState(!1);b.useEffect(()=>{const a=window.fbq;a&&(a("init","1586996642399699"),a("track","PageView"))},[]);const f=a=>{const r=a.replace(/\D/g,"");return r.length<=10?r.replace(/^(\d{2})(\d)/g,"($1) $2").replace(/(\d{4})(\d)/,"$1-$2"):r.replace(/^(\d{2})(\d)/g,"($1) $2").replace(/(\d{5})(\d)/,"$1-$2")},i=a=>{const{id:r,value:t}=a.target;if(r==="telefone"){const s=f(t.slice(0,15));d(n=>({...n,[r]:s}))}else d(s=>({...s,[r]:t}))},u=async a=>{if(a.preventDefault(),o.captcha.trim()!=="10"){l.error("Por favor, responda a verificação matemática corretamente: 9 + 1 = 10.");return}p(!0);try{const r=window.fbq;r&&r("track","Lead",{content_category:"Qualificacao_Geral",content_name:"Formulario_Experimentar"});const t=o.conselho.toUpperCase(),n={1:"Apenas eu (1)","2-5":"De 2 a 5","6-10":"De 6 a 10","11+":"Mais de 10"}[o.profissionais]||o.profissionais;await g.post("/leads/qualify",{nome:o.nome,email:o.email,senha:o.senha,telefone:o.telefone,conselho:t,profissionais:n});const x=`Olá SomosFisio! Tenho interesse em conhecer seus serviços. Aqui estão meus dados de contato:
